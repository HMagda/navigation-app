...
export default function Form({ defaultValues, onSubmit, onCancel }: FormProps) {
  ...
  return (
    <form
      ...
      className='border border-borderColor rounded-lg p-6 space-y-4 m-containerMargin relative bg-white'
    >
      {/* Trash Icon */}
      <button
        type='button'
      ...
      <div>
        ...
        <input
          ...
          className='w-full border border-borderColor rounded-lg p-2 focus:ring-2 focus:ring-primary focus:outline-none'
      ...
      <div className='flex justify-start space-x-4'>
        <button
          type='button'
          onClick={onCancel}
          className='px-4 py-2 text-buttonText font-buttonText border border-borderColor rounded-lg hover:bg-gray-100 h-buttonHeight'
        >
          Anuluj
        </button>
        <button
